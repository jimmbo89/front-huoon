      ...
      <v-card-text>
        <v-row class="mb-4" align="center" dense>
          ...
          <v-col cols="12" sm="10" md="10" class="d-flex align-center">
            ...
            <div>
              <div class="text-body-2 font-weight-bold mb-1">Presupuestos</div>
                      ...
                      <v-avatar
                        ...
                        :style="{
                          ...
                          color: getContrastText(
                            getTypeColor(slotProps.item.budget_type)
                          ),
                          'min-height': '48px',
                          'min-width': '48px',
                          'border-radius': '8px',
                  ...
                  >
                    <template v-slot:item="{ props, item }">
                      <v-list-item v-bind="props" class="dropdown-item">
                        ...
                        <v-tooltip
                          location="top"
                          :text="`Descripción: ${item.raw.descriptionCategory}`"
                        >
...
export default {
  ...
  data: () => ({
    ...
    currencyRules: [(v) => !!v || "La moneda es requerida"],
  ...
  watch: {
    ...
    selectedParent(newParentId) {
      if (newParentId) {
        ...
        this.categoryChildren = this.categories.filter(
          (cat) => cat.parent_id === newParentId
        );
        // Si no hay selección, limpiar subcategoría
        if (
          !this.editedItem.category_id ||
          !this.categoryChildren.some((c) => c.id === this.editedItem.category_id)
        ) {
