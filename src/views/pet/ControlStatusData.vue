          ...
          <td colspan="100%" style="padding: 0; border: none"> 
                ...
                >
                  ...
                  >
                    ...
                    <div style="width: 75%; min-width: 0" class="d-flex align-center">
                      ...
                      <div class="d-flex flex-column justify-center" style="min-width: 0">
                        ...
                        <div class="text-caption text--secondary">
                          {{ item.totalControls }} control{{
                            item.totalControls !== 1 ? "s" : ""
                          }}
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <v-icon
                        :color="!item.hasControls ? 'success' : 'red'"
                        size="25"
                        class="mr-1"
                      >
                        {{
            ...
            <!-- Fila expandida -->
            <tr v-if="isExpanded(item.id) && item.hasControls">
                    ...
                    >
                      <div style="width: 7%" class="text-body-2">
                        <v-avatar
                          ...
                          :class="`bg-${getTypeColor(control.typeName)}`"
                          :style="{
                            'min-height': '48px',
                            'min-width': '48px',
                            'border-radius': '8px',
                        ...
                        >
                          <div class="text-body-3 font-weight-medium">
                            {{ formatIntuitiveDate(control.next_date) }}
                          </div>
                        </v-avatar>
                        <v-tooltip
                          activator="parent"
                      ...
                      >
                        {{ control.name }}
                        <div v-if="control.dosage" class="text-caption text-grey-darken-1 text-truncate">
                          {{ control.dosage }} {{ control.unit }} 
                        </div>
                      </div>
...
export default defineComponent({
  ...
  data: () => ({
    ...
    headers: [
      ...
      { title: "Estado", key: "hasControls" },
      { title: "Cantidad", key: "totalControl" },
    ],
  }),
  computed: {
      isMobile() {
