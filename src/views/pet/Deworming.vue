      ...
      >
        ...
        >
          <div style="width: 7%; min-width: 0" class="text-left">
            {{ $t("dewormings.fields.date") }}
          </div>
          <div style="width: 20%; min-width: 0" class="text-left">
            {{ $t("dewormings.fields.name") }}
          </div>
          <div style="width: 10%; min-width: 0" class="text-left">
            {{ $t("dewormings.fields.dosage") }}
          </div>
          <div style="width: 41%; min-width: 0" class="text-left">
            {{ $t("dewormings.fields.notes") }}
          </div>
          <div style="width: 15%; min-width: 0" class="text-left">
            {{ $t("dewormings.fields.next_date") }}
          </div>
    ...
    <tr
      ...
      >
        ...
        >
          ...
          <!-- Columna 3: Notas (45%) -->
          <div style="width: 41%; min-width: 0" class="d-flex flex-column">
            <div
                ...
                <v-locale-provider>
                  <v-menu v-model="menu" :close-on-content-click="true" offset-y min-width="auto" transition="scale-transition" location="end">
                    <template v-slot:activator="{ props }">
                      <v-text-field v-bind="props" :modelValue="input" variant="underlined" :rules="[
              ...
              <v-col cols="12" md="6">
                <v-locale-provider>
                    <v-menu v-model="menu2" :close-on-content-click="true" offset-y min-width="auto" transition="scale-transition" location="end">
                      <template v-slot:activator="{ props }">
                        <v-text-field v-bind="props" :model-value="input2"
                          :label="$t('dewormings.fields.next_date')" variant="underlined" readonly></v-text-field>
                      </template>
                      <v-date-picker :modelValue="input2" @update:model-value="updateDate1"
                        format="yyyy-MM-dd" color="#03626C"
                        :min="input"></v-date-picker>
                    </v-menu>
                    </v-locale-provider>
              </v-col>
            </template>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { title: "Dosis", value: "dosage", width: "10%" },
      { title: "Unidad", value: "unit", width: "10%" },
      { title: "Notas", value: "notes", width: "10%" },
      { title: "Siguiente dosis", value: "next_date", width: "10%" },
  ...
  created() {
    this.tools = [
      {
        name: this.$t("dewormings.listing.addButton"),
        action: () => this.showAdd(),
      },
    ];
  },
