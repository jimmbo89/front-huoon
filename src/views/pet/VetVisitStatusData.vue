          ...
          <td colspan="100%" style="padding: 0; border: none"> 
                ...
                >
                  ...
                  >
                    ...
                    <div style="width: 75%; min-width: 0" class="d-flex align-center">
                      ...
                      <div class="d-flex flex-column justify-center" style="min-width: 0">
                        ...
                        <div class="text-caption text--secondary">
                          {{ item.totalVetVisits }} cita{{
                            item.totalVetVisits !== 1 ? "s" : ""
                          }}
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <v-icon
                        :color="!item.hasVetVisits ? 'success' : 'red'"
                        size="25"
                        class="mr-1"
                      >
                        {{
            ...
            <!-- Fila expandida -->
            <tr v-if="isExpanded(item.id) && item.hasVetVisits">
              <td colspan="100%" class="pa-0" style="background: #fafafa">
                <div class="px-2 pb-4">
                  <v-card
                    v-for="vetvisit in item.vetVisits"
                    :key="vetvisit.id"
                    class="mb-2 mx-1 rounded-lg"
                    elevation="1"
                    density="comfortable"
                    ...
                    >
                      <div style="width: 7%" class="text-body-2">
                        <v-avatar
                          ...
                          :class="`bg-${getTypeColor(vetvisit.typeName)}`"
                          :style="{
                            'min-height': '48px',
                            'min-width': '48px',
                            'border-radius': '8px',
                        ...
                        >
                          <div class="text-body-3 font-weight-medium">
                            {{ formatIntuitiveDate(vetvisit.next_date) }}
                          </div>
                        </v-avatar>
                        <v-tooltip
                          activator="parent"
...
export default defineComponent({
  ...
  data: () => ({
    ...
    headers: [
      ...
      { title: "Estado", key: "hasVetVisits" },
      { title: "Cantidad", key: "totalVetVisits" },
    ],
  }),
  computed: {
      isMobile() {
